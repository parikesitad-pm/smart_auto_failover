    ...
    <section className="relative pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto">
        ...
        <a
          href={
            release?.htmlUrl ||
            `https://github.com/parikesitad-pm/smart_auto_failover/releases/tag/${release?.tagName || 'v3.1.0'}`
          }
          target="_blank"
          rel="noopener noreferrer"
          title={`View ${release ? release.tagName : 'v3.1.0'} on GitHub Releases`}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          ...
          >
            GitHub Release ({release ? release.tagName : 'v3.1.0'})
