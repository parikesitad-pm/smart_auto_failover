...
- **Designated Release 24 as Official Beta Release & Updated Cockpit Showcase (`README.md`, `website/src/`, `website/public/dashboard_app.png`, `assets/dashboard_app.png`)**: Established `v3.0.0-preview.24` as the official multi-platform Beta Release with direct download links (`AutoFailover-3.0.0-Windows-x64.zip`, `AutoFailover-3.0.0-Linux-x86_64.tar.gz`, `AutoFailover-3.0.0-macOS-arm64.dmg`) in `README.md`. Updated landing page screenshot to the authentic Windows desktop cockpit running live with active Wi-Fi, Ethernet alert, and vMix session protection.
